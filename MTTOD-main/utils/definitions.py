#,"chit","answer"
ALL_DOMAINS = ["attraction", "hotel", "restaurant", "taxi", "train", "hospital", "police","chit","answer","recommend"]
...
DIALOG_ACTS = {
    ...
    ##扩充act
    'answer':['document_act','answer_question'],
    'chit':['chit_act'],
    'recommend':['Recommend_act','Recommend_chitchat']
}
