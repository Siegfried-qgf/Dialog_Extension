...
class CrossModel(nn.Module):
    def __init__(self, opt, dictionary, is_finetune=False, padding_idx=0, start_idx=1, end_idx=2, longest_label=1):
        ...
        self.kg = pkl.load(open("./data/CRS/ReDial/subkg.pkl", "rb"))
    ...
    def forward(self, xs, ys, mask_ys, concept_mask, db_mask, seed_sets, labels, con_label, db_label, entity_vector, rec, test=True, cand_params=None, prev_enc=None, maxlen=None,
        ...
        con_emb4gen = con_nodes_features4gen[concept_mask]#todo concept_mask
        ...
        db_encoding=(self.db_norm(db_emb4gen),db_mask4gen.cuda())#todo entity_vector
    ...
    def load_model(self):
        #4/21
        self.load_state_dict(torch.load('./../KGSF/saved_model/net_parameter1.pkl'))
